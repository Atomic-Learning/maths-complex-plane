A complex number $z = x + iy$ can be visualized as a point in a two-dimensional plane called the **complex plane** or **Argand diagram**, named after mathematician Jean-Robert Argand. This geometric representation of complex numbers provides an intuitive way to understand their properties and operations. In the complex plane, the coordinates of a point correspond to the real and imaginary parts of a complex number:
...
![The complex plane with several example complex numbers plotted](resources/complex-plane.png)
